...
import { AddSeerStorePaymentMethodCommand } from './add-seer-store-payment-method.command';
import { EventstoreService } from '@app/eventstore';
import {SeerStoreNotFoundException} from "../../exception/store-not-found.exception";

@CommandHandler(AddSeerStorePaymentMethodCommand)
export class AddSeerStorePaymentMethodHandler
  implements ICommandHandler<AddSeerStorePaymentMethodCommand>
{
  constructor(
  ...
  async execute(command: AddSeerStorePaymentMethodCommand) {
